...
> Pour ce repo, suivre d'abord `../../README.md` et `../../scripts/setup-tradingview-mcp.sh`.
> Les règles locales SMC/ICT et `WORKSPACE_NOTES.md` priment sur la documentation standalone ci-dessous.
